...
class TestG3T1_2ConnectedSensor(object):
    """Tests for G3T1_2 when connected to a real sensor (spo2 service)."""
    ...
    def setup_class(cls):
        ...
        if not rospy.core.is_initialized():
            rospy.init_node("node_test_g3t1_2_connected", anonymous=True)
