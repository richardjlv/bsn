...
class TestG3T1_1ConnectedSensor(object):
    """Tests for G3T1_1 when connected to a real sensor (spo2 service)."""
    ...
    def setup_class(cls):
        ...
        if not rospy.core.is_initialized():
            rospy.init_node("node_test_g3t1_1_connected", anonymous=True)
    ...
    def test_collect_uses_spo2_service_value(self):
