...
class TestG3T1_5ConnectedSensor(object):
    """Tests for G3T1_5 when connected to a real sensor (spo2 service)."""
    ...
    def setup_class(cls):
        ...
        if not rospy.core.is_initialized():
            rospy.init_node("node_test_G3T1_5_connected", anonymous=True)
